...
movieName
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    ...
    Phone number
      ...
      <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"  type="number"
        onChange={(e)=>{
  ...
  <div className="flex flex-wrap -mx-3 mb-2">
    <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
      ...
      <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"  type="text" placeholder="Albuquerque" onChange={(e)=>{
  ...
  <button className='p-2 rounded-t-2xl border-solid bg-purple-200' type='submit' onClick={()=> handleSubmit}>{button}</button>
</div></form>
    </div>
  )
}
